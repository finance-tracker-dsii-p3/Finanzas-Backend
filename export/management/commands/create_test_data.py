...
class Command(BaseCommand):
    help = "Crear datos simulados para agosto y septiembre 2025"

    def handle(self, *args, **options):
        self.stdout.write(
            self.style.SUCCESS("Creando datos simulados para agosto-septiembre 2025...")
        )
    ...
    def create_courses(self):
        ...
        for course_data in courses_data:
            course, created = Course.objects.get_or_create(
                code=course_data["code"], defaults=course_data
            )
            if created:
        ...
        for i in range(num_reports):
            ...
            report, created = EquipmentReport.objects.get_or_create(
                ...
                defaults={
                    ...
                    "resolution_notes": "Problema reportado y en proceso de resolución"
                    if severity in ["medium", "high", "critical"]
                    else "Problema menor, resuelto rápidamente",
                    "resolved_at": report_time + timedelta(hours=random.randint(1, 48))
