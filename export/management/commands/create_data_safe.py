...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        self.stdout.write(self.style.SUCCESS('Creando datos simulados usando usuarios existentes...'))
        ...
        try:
            ...
            if not monitors.exists():
                self.stdout.write(self.style.ERROR('No hay monitores disponibles. Se necesitan monitores para crear datos.'))
                return
            ...
            self.stdout.write(f'Usando {admins.count()} administradores y {monitors.count()} monitores existentes')
