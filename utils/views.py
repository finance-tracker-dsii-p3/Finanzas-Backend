...
class BaseCurrencyViewSet(viewsets.ViewSet):
    ...
    def set_base(self, request):
        ...
        serializer = BaseCurrencySerializer(data=request.data, context={"request": request})
...
class ExchangeRateViewSet(viewsets.ModelViewSet):
    ...
    def convert(self, request):
        ...
        to_currency = (
            to_currency.upper() if to_currency else FxService.get_base_currency(request.user)
        )
