...
def create_test_data():
    ...
    transactions_data = [
        ...
        {
            "date": date(today.year, today.month, 8),
            "type": 2,
            "description": "Cine",
            "base_amount": 25000,
            "total_amount": 30000,
        ...
        {
            "date": date(today.year, today.month, 20),
            "type": 2,
            "description": "Mercado",
            "base_amount": 85000,
            "total_amount": 95000,
        ...
        {
            "date": date(today.year, today.month, 22),
            "type": 2,
    ...
    # Calcular totales
    total_income = (
        Transaction.objects.filter(user=user, type=1).aggregate(
    ...
    total_expenses = (
        Transaction.objects.filter(user=user, type=2).aggregate(
            total=django.db.models.Sum("base_amount")
        )["total"]
        or 0
    )
