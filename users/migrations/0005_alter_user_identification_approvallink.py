        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "expires_at",
                    models.DateTimeField(
                        help_text="Fecha y hora de expiración del enlace", verbose_name="Expira en"
                    ),
                ),
            ...
            options={
                ...
                "ordering": ["-created_at"],
                "indexes": [
                    models.Index(fields=["token_hash"], name="users_appro_token_h_409bce_idx"),
                    models.Index(fields=["user", "action"], name="users_appro_user_id_1da152_idx"),
                    models.Index(fields=["expires_at"], name="users_appro_expires_2eb7c2_idx"),
                ],
            },
        ),
    ]
