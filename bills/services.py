...
class BillService:
    ...
    def check_and_create_reminders():
        ...
        return {
            ...
            "upcoming": len([r for r in created_reminders if r.reminder_type == BillReminder.UPCOMING]),
            "due_today": len([r for r in created_reminders if r.reminder_type == BillReminder.DUE_TODAY]),
            "overdue": len([r for r in created_reminders if r.reminder_type == BillReminder.OVERDUE]),
        }
