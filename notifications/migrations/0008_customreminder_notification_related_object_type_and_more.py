...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="Título del recordatorio", max_length=200, verbose_name="Título"
                    ),
                ),
                (
                    "message",
                    models.TextField(
                        help_text="Mensaje detallado del recordatorio", verbose_name="Mensaje"
                    ),
                ),
                (
                    "reminder_date",
        ...
        migrations.AddIndex(
            model_name="customreminder",
            index=models.Index(
                fields=["reminder_date", "reminder_time"], name="notificatio_reminde_4ecb46_idx"
            ),
        ),
    ]
