...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stdout.write(
                self.style.SUCCESS(f"  ✓ Facturas verificadas: {bill_stats['total_bills_checked']}")
            )
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS(f"  ✓ {len(soat_alerts)} alertas de SOAT creadas"))
        ...
        self.stdout.write(
            self.style.SUCCESS(f"  ✓ Total de notificaciones enviadas: {total_notifications}")
        )
        self.stdout.write(
