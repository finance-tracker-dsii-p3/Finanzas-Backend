...
class BudgetViewSet(viewsets.ModelViewSet):
    ...
    def categories_without_budget(self, request):
        ...
        categories = BudgetService.get_categories_without_budget(
            user=request.user,
            period=period
        )
        ...
        return Response({
            ...
            'message': 'Estas categorías aún no tienen presupuesto asignado.' if categories_data else 'Todas tus categorías de gasto tienen presupuesto.'
        })
    ...
    def alerts(self, request):
        ...
        return Response({
            ...
            'alerts': alerts_data,
            'message': 'Tienes presupuestos que requieren atención.' if alerts_data else 'Todos tus presupuestos están bajo control.'
        })
