...
class BudgetAdmin(admin.ModelAdmin):
    ...
    list_filter = ["is_active", "period", "calculation_mode", "created_at"]

    search_fields = ["user__username", "user__email", "category__name"]

    readonly_fields = ["id", "created_at", "updated_at", "spent_info_display", "projection_display"]

    fieldsets = (
        ("Información Básica", {"fields": ("id", "user", "category", "amount", "is_active")}),
        (
            "Configuración",
        ...
        (
            "Estadísticas",
            {"fields": ("spent_info_display", "projection_display"), "classes": ("collapse",)},
        ),
    ...
    def calculation_mode_badge(self, obj):
        ...
        colors = {"base": "#3B82F6", "total": "#10B981"}
        return format_html(
    ...
    def period_badge(self, obj):
        ...
        colors = {"monthly": "#8B5CF6", "yearly": "#F59E0B"}
        return format_html(
            '<span style="background-color: {}; color: white; padding: 2px 8px; '
            'border-radius: 3px; font-size: 11px;">{}</span>',
    ...
    def status_badge(self, obj):
        ...
        colors = {"good": "#10B981", "warning": "#F59E0B", "exceeded": "#EF4444"}
        texts = {"good": "✓ OK", "warning": "⚠ Alerta", "exceeded": "✗ Excedido"}
        return format_html(
    ...
    def is_active_badge(self, obj):
        ...
        if obj.is_active:
            return format_html('<span style="color: #10B981; font-weight: bold;">● Activo</span>')
        return format_html('<span style="color: #EF4444; font-weight: bold;">● Inactivo</span>')
