...
class AutomaticRuleListSerializer(serializers.ModelSerializer):
    ...
    target_transaction_type_display = serializers.CharField(
        source='get_target_transaction_type_display', 
        read_only=True
    )
    ...
    class Meta:
        ...
        fields = [
            ...
            'keyword', 'target_transaction_type', 'target_transaction_type_display',
            'action_type', 'action_type_display', 'target_category', 'target_category_name',
            'target_category_color', 'target_category_icon', 'target_tag',
            'is_active', 'order', 'applied_count', 'created_at', 'updated_at'
        ]
...
class AutomaticRuleDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'name', 'criteria_type', 'criteria_type_display',
            'keyword', 'target_transaction_type', 'target_transaction_type_display',
            'action_type', 'action_type_display', 'target_category', 'target_category_info',
            'target_tag', 'is_active', 'order', 'statistics', 'created_at', 'updated_at'
        ]
...
class AutomaticRuleCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AutomaticRule
        fields = [
            'name', 'criteria_type', 'keyword', 'target_transaction_type',
            'action_type', 'target_category', 'target_tag', 'is_active', 'order'
        ]
...
class AutomaticRuleUpdateSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        if criteria_type == AutomaticRule.DESCRIPTION_CONTAINS:
            ...
            target_transaction_type = data.get('target_transaction_type', instance.target_transaction_type)
