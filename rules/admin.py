...
class AutomaticRuleAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ("Información Básica", {"fields": ["user", "name", "is_active", "order"]}),
        (
        ...
        (
            "Estadísticas",
            {"fields": ["applied_count", "created_at", "updated_at"], "classes": ["collapse"]},
        ),
    ]
    ...
    def activate_rules(self, request, queryset):
        ...
        self.message_user(request, f"{updated} reglas activadas exitosamente.")
    ...
    def deactivate_rules(self, request, queryset):
        ...
        self.message_user(request, f"{updated} reglas desactivadas exitosamente.")
