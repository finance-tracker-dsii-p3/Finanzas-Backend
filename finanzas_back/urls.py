...
def health_check(request):
    ...
    try:
        ...
        return JsonResponse(
            {"status": "unhealthy", "error": str(e), "django_version": django.VERSION}, status=500
        )
...
def root_view(request):
    """Root endpoint"""
    return JsonResponse(
        {"message": "Finanzas Backend API", "status": "running", "version": "1.0.0"}
    )
...
urlpatterns = [
    ...
    path("api/credit-cards/", include("credit_cards.urls")),  # HU-16: Planes y pagos de tarjeta
