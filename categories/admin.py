...
class CategoryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Información Básica", {"fields": ("user", "name", "type")}),
        ("Apariencia", {"fields": ("color", "color_preview", "icon")}),
        ("Estado y Orden", {"fields": ("is_active", "is_default", "order")}),
        (
            "Uso",
            {"fields": ("usage_count_display", "related_data_display"), "classes": ("collapse",)},
        ),
    ...
    def user_link(self, obj):
        ...
        return format_html(
            '<a href="/admin/users/user/{}/change/">{}</a>', obj.user.id, obj.user.username
        )
    ...
    def icon_display(self, obj):
        ...
        return format_html('<i class="fas {}"></i> {}', obj.icon, obj.get_icon_display())
    ...
    def usage_count_display(self, obj):
        ...
        return format_html("<strong>{}</strong> usos", count)
