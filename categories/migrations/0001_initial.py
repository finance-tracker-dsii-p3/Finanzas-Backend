        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Nombre de la categoría (ej: Comida, Salario)", max_length=100
                    ),
                ),
                (
                    "type",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=7,
                        validators=[
                            categories.models.validate_hex_color,
                            categories.models.validate_color_contrast,
                        ],
                    ),
                ),
                (
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0, help_text="Orden de visualización en listas"
                    ),
                ),
                (
                    "created_at",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["user", "type", "is_active"], name="categories__user_id_d42513_idx"
                    ),
                    models.Index(
                        fields=["user", "is_active"], name="categories__user_id_15497c_idx"
                    ),
                ],
            },
        ),
