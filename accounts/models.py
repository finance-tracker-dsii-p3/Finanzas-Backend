...
class Account(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="accounts", verbose_name="Usuario propietario"
    )
    ...
    account_type = models.CharField(
        max_length=20, choices=ACCOUNT_TYPE_CHOICES, verbose_name="Tipo de cuenta"
    )

    category = models.CharField(max_length=30, choices=CATEGORY_CHOICES, verbose_name="Categoría")

    current_balance = models.DecimalField(
        max_digits=15, decimal_places=2, default=Decimal("0.00"), verbose_name="Saldo actual"
    )

    currency = models.CharField(
        max_length=3, choices=CURRENCY_CHOICES, default="COP", verbose_name="Moneda"
    )
...
class AccountOption(models.Model):
    ...
    name = models.CharField(
        max_length=100, verbose_name="Nombre", help_text="Nombre del banco, billetera o entidad"
    )
