...
class AccountAdmin(admin.ModelAdmin):
    ...
    list_filter = ["account_type", "category", "currency", "is_active", "created_at"]
    ...
    fieldsets = (
        ...
        ("Detalles Financieros", {"fields": ("current_balance", "currency", "gmf_exempt")}),
        (
            "Tarjeta de Crédito",
            {
                "fields": ("expiration_date", "credit_limit"),
                "classes": ("collapse",),
                "description": "Solo aplica para tarjetas de crédito",
            },
        ),
        ("Estado y Fechas", {"fields": ("is_active", "created_at", "updated_at")}),
        ("Información Técnica", {"fields": ("id",), "classes": ("collapse",)}),
    )
    ...
    def activate_accounts(self, request, queryset):
        ...
        self.message_user(request, f"{updated} cuenta(s) activada(s) exitosamente.")
    ...
    def deactivate_accounts(self, request, queryset):
        ...
        self.message_user(request, f"{updated} cuenta(s) desactivada(s) exitosamente.")
...
class AccountOptionAdmin(admin.ModelAdmin):
    ...
    list_display = ["name", "option_type_display", "is_active", "order", "created_at"]

    list_filter = ["option_type", "is_active", "created_at"]
    ...
    fieldsets = (
        ("Información básica", {"fields": ("name", "option_type")}),
